...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='FVASIS', help='selects model to use for netG (pix2pixhd | spade)')
        ...
        parser.add_argument('--norm_mode', type=str, default='spade', help='[spade | clade | variation]')
