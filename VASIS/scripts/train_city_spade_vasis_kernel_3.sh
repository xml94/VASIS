...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_avg_learn_one \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_random_cat_all_learn_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_no_learn_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_one_learn_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_learn_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_learn_all \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_fix_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_relative_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_fix_relative_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_fix_learn_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
...
python train.py --name "$date"_"$norm_mode"_kernel_"$kernel_norm"_norm_cat_all_fix_learn_relative_one \
--dataset_mode cityscapes --dataroot "./../datasets/cityscapes" \
--norm_mode "$norm_mode" --gpu_ids $gpu \
--batchSize $batch --niter $niter --niter_decay $niter_decay \
--train_eval --eval_epoch_freq $freq \
