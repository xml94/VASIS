...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--num_workers', type=int, default=16, help='num_workers argument for dataloader')
    ...
    if train:
        parser.add_argument('--freq_print', type=int, default=10, help='frequency of showing training results')
        parser.add_argument('--freq_save_ckpt', type=int, default=200, help='frequency of saving the checkpoints')
        parser.add_argument('--freq_save_latest', type=int, default=100, help='frequency of saving the latest model')
        ...
        parser.add_argument('--freq_fid', type=int, default=50, help='frequency of saving the fid score (in training iterations)')
